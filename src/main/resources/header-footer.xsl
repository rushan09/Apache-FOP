...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/">
		<fo:static-content flow-name="xsl-region-before">
			...
			<fo:block font-size="12pt" text-align="center" font-family="Times"
				font-weight="normal">
				<fo:inline color="#207A8C"><xsl:value-of select="$psubtitle" /></fo:inline>
			</fo:block>
		</fo:static-content>
		<fo:static-content flow-name="xsl-region-after">
			<fo:block font-size="6pt" text-align="center" font-family="Times"
				margin-bottom="2mm">
				<fo:inline color="#9D0808">Copyright &#169; 2016 MDL. All rights reserved</fo:inline>				
			</fo:block>
